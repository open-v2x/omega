...
import { createModel, modelInfo, updateModel } from '#/services/api/device/model';
import { CreateModalProps, FormGroupType } from '#/typings/pro-component';
import React, { FC } from 'react';

const CreateModelModal: FC<CreateModalProps> = ({ editId, success }) => {
  ...
  return (
    <Modal
      ...
      editId={editId}
      request={async ({ id }) => {
        const result = await modelInfo(id);
        return result;
      }}
    >
